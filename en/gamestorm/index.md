    ...
    <div class="media-block media-block--start">
      <figure class="media-block__media">
        <picture>
          ...
          <img src="{{ '/assets/images/gamestorm/sessie.jpg' | relative_url }}" alt="A GameStorm session where we explore the learning challenge together" width="1400" height="933" loading="lazy" decoding="async">
        </picture>
      </figure>
      <div class="media-block__body">
        <span class="section-label">From learning goal to story</span>
        <h2>A first story that sets direction</h2>
        <p>
          If game-based learning fits your case, we translate the learning challenge into a first storyline. We use a
          recognisable narrative structure in which the participant faces a challenge, makes choices and experiences the
          consequences.
        </p>
        <p>
...
<section class="section">
  <div class="container">
    <div class="split split--wide-text">
      <div class="split__text">
        <span class="section-label">Start with a low threshold</span>
        <h2>A manageable first investment</h2>
        <p>
          A GameStorm lasts one half-day, takes place on location and costs €500. If you decide to continue with
      ...
      <div class="split__aside">
        <div class="price-card">
          ...
          <span class="price-card__meta">one half-day · on location</span>
          <span class="price-card__note">Fully credited against a follow-up project.</span>
        </div>
      </div>
    </div>
  </div>
