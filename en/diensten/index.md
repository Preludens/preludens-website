...
lang: en
title: Services
description: MicroGame Stories, Dilemma Storytelling and Game Thinking — three routes to make complex knowledge playable and applicable.
permalink: /diensten/
---
  ...
  <div class="container">
    <div class="hero-banner__inner">
      ...
      <div class="hero-banner__actions">
        ...
        <a class="btn btn-secondary" href="{{ '/gamestorm/' | relative_url }}">Start with a GameStorm</a>
      </div>
    </div>
  </div>
    ...
    <article class="service-block service-block--coral">
      <div class="service-block__intro">
        ...
        <p>
          ...
          burdening people with long, passive modules.
        </p>
      </div>
      <div class="service-block__cols">
        ...
        <div class="service-block__result">
          ...
          <p>
            They do not only read what they need to know — they are taken into a story. They recognise situations, make
            choices, receive feedback and practise with the knowledge they will need later.
          </p>
          <a class="btn btn-primary" href="{{ '/contact/' | relative_url }}">More about MicroGame Stories <span class="btn__arrow" aria-hidden="true">&rarr;</span></a>
        </div>
      </div>
    </article>
  </div>
    ...
    <article class="service-block service-block--gold">
      ...
      <div class="service-block__cols">
        ...
        <div class="service-block__result">
          <h3>What participants experience</h3>
          <p>
            They step into a recognisable situation, make a choice and see what that choice causes. That creates
            conversation, insight and more awareness of how they act in practice.
          </p>
          <a class="btn btn-primary" href="{{ '/contact/' | relative_url }}">More about Dilemma Storytelling <span class="btn__arrow" aria-hidden="true">&rarr;</span></a>
        </div>
      </div>
    </article>
  </div>
    ...
    <article class="service-block service-block--mint">
      ...
      <div class="service-block__cols">
        ...
        <div class="service-block__result">
          ...
          <p>
            Game Thinking gives direction before you start developing. You get more grip on the audience, the learning
            goals, the desired change and the form that fits.
          </p>
          <a class="btn btn-primary" href="{{ '/contact/' | relative_url }}">More about Game Thinking <span class="btn__arrow" aria-hidden="true">&rarr;</span></a>
        </div>
      </div>
    </article>
  </div>
...
<section class="section section--navy">
  <div class="container">
    <div class="block-head">
      <span class="section-label">Which route fits your challenge?</span>
      <h2>From first question to playable learning experience</h2>
      <p>
        Not every challenge asks for the same solution. That is why we do not start with the form, but with the
        learning task. What do people need to understand, practise or do differently? From that question we determine
...
<section class="cta-feature">
  <div class="container">
    <div class="cta-feature__inner">
      <span class="section-label">Discover which learning route fits your team</span>
